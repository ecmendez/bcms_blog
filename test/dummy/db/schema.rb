...
ActiveRecord::Schema.define(version: 20120813180110) do
  ...
  add_index "cms_attachment_versions", ["original_record_id", "version"], name: "index_cms_attachment_versions_on_attachment_and_version", using: :btree
  ...
  add_index "cms_connectors", ["connectable_id", "connectable_type"], name: "index_cms_connectors_on_connectable_id_and_connectable_type", using: :btree
  ...
  add_index "cms_connectors", ["page_id", "page_version"], name: "index_cms_connectors_on_page_id_and_version", using: :btree
  ...
  add_index "cms_file_block_versions", ["original_record_id", "version"], name: "index_cms_file_block_versions_on_file_block_and_version", using: :btree
  ...
  add_index "cms_html_block_versions", ["original_record_id", "version"], name: "index_cms_html_block_versions_on_html_block_and_version", using: :btree
  ...
  create_table "cms_info_items", force: true do |t|
    t.string   "icon"
    t.string   "title"
    t.string   "url"
    t.text     "body"
  ...
  add_index "cms_link_versions", ["original_record_id", "version"], name: "index_cms_link_versions_on_link_and_version", using: :btree
  ...
  create_table "cms_news_items", force: true do |t|
    t.string   "title"
    t.string   "url"
    t.text     "body"
    t.boolean  "visible"
  ...
  add_index "cms_page_versions", ["original_record_id", "version"], name: "index_cms_page_versions_on_page_and_version", using: :btree
  ...
  add_index "cms_section_nodes", ["node_type", "node_id"], name: "index_cms_section_nodes_on_node_type_and_node_id", using: :btree
  ...
  add_index "cms_taggings", ["tag_id"], name: "index_cms_taggings_on_tag_id", using: :btree
  add_index "cms_taggings", ["taggable_id", "taggable_type"], name: "index_cms_taggings_on_taggable_id_and_taggable_type", using: :btree
